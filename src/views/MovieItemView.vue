<template>
  <div class="visually-hidden">
    <!-- inject:svg --><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><symbol id="add" viewBox="0 0 19 20">
  ...
  <div class="page-content">
    <section class="catalog catalog--like-this">
      ...
      <div class="catalog__movies-list">
        ...
        <article class="small-movie-card catalog__movies-card">
          <div class="small-movie-card__image">
            <img src="../assets/img/bohemian-rhapsody.jpg" alt="Bohemian Rhapsody" width="280" height="175" />
          </div>
          <h3 class="small-movie-card__title">
        ...
        <article class="small-movie-card catalog__movies-card">
          <div class="small-movie-card__image">
            <img src="../assets/img/macbeth.jpg" alt="Macbeth" width="280" height="175" />
          </div>
          <h3 class="small-movie-card__title">
        ...
        <article class="small-movie-card catalog__movies-card">
          <div class="small-movie-card__image">
            <img src="../assets/img/aviator.jpg" alt="Aviator" width="280" height="175" />
          </div>
          <h3 class="small-movie-card__title">
